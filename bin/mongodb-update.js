...
const toRemove = [
  {collection: 'workcenters', _id: 'RC340B-2'},
  {collection: 'prodflows', _id: new ObjectId('5d9c21f18e2a3909007e1558')}
];
const toUpdate = [{
  oldOrgUnits: {
    division: 'LPc',
    ...
    mrpControllers: ['KF1'],
    prodFlow: new ObjectId('5d9c21f18e2a3909007e1558'),
    workCenter: 'RC340B-2',
    prodLine: 'LM-51'
  },
  newOrgUnits: {
    ...
    subdivision: new ObjectId('529f2685cd8eea9824000018'),
    mrpControllers: ['KF2'],
    prodFlow: new ObjectId('5dd69faa636df60c2cedfa1d'),
    workCenter: 'SM340_1',
    prodLine: 'LM-51'
  },
  fteMasterEntry: 'transfer',
  names: {
    prodLine: 'Montaż FlexBlend S&S - LM-51'
  }
}];
