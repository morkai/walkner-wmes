...
const toRemove = [
  {collection: 'workcenters', _id: 'MAXOSACC'},
  {collection: 'prodflows', _id: new ObjectId('587483e8aea05909240d2a24')}
];
const toUpdate = [];

['2DIMECO_', 'DEFOIL_', 'PIVATIC_', 'SAFAN_6', 'SAFAN_7', 'SAFAN_8'].forEach(prodLine =>
{
  toUpdate.push({
    oldOrgUnits: {
      division: 'LPa',
      subdivision: new ObjectId('529f2654cd8eea9824000012'),
      mrpControllers: ['KS9'],
      prodFlow: new ObjectId('583dbe4c27d851581c97d1c3'),
      workCenter: prodLine.replace('_', ''),
      prodLine
    },
    newOrgUnits: {
      division: 'LPa',
      subdivision: new ObjectId('529f2654cd8eea9824000012'),
      mrpControllers: ['KS2'],
      prodFlow: new ObjectId('559a63a332de99e04e217a33'),
      workCenter: prodLine.replace('_', ''),
      prodLine
    },
    fteMasterEntry: {
...
for (let i = 1; i <= 11; ++i)
{
  ...
  toUpdate.push({
    oldOrgUnits: {
      ...
      mrpControllers: ['KGA'],
      prodFlow: new ObjectId('587483e8aea05909240d2a24'),
      workCenter: 'MAXOSACC',
      prodLine
    },
    newOrgUnits: {
      ...
      subdivision: new ObjectId('529f264acd8eea9824000010'),
      mrpControllers: ['KGA'],
      prodFlow: db.prodflows.findOne({name: new RegExp(`${prodLine}$`)})._id,
      workCenter: prodLine,
      prodLine
    },
    fteMasterEntry: {
  ...
  db.prodlines.updateOne({_id: prodLine}, {$set: {workCenter: prodLine}});
}
