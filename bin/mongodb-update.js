...
const toUpdate = [{
  oldOrgUnits: {
    ...
    mrpControllers: ['KE6'],
    prodFlow: new ObjectId('5607326b1b7251582490bc03'),
    workCenter: 'T2LED-3',
    prodLine: 'CT3'
  },
  newOrgUnits: {
  ...
  oldOrgUnits: {
    ...
    subdivision: new ObjectId('529f2685cd8eea9824000018'),
    mrpControllers: ['KE6'],
    prodFlow: new ObjectId('5607326b1b7251582490bc04'),
    workCenter: 'T2LED-4',
    prodLine: 'CT4'
  },
  newOrgUnits: {
  ...
  oldOrgUnits: {
    ...
    subdivision: new ObjectId('529f2685cd8eea9824000018'),
    mrpControllers: ['KE6'],
    prodFlow: new ObjectId('5607326b1b7251582490bc05'),
    workCenter: 'T2LED-5',
    prodLine: 'CT5'
  },
  newOrgUnits: {
  ...
  oldOrgUnits: {
    ...
    subdivision: new ObjectId('529f2685cd8eea9824000018'),
    mrpControllers: ['KE6'],
    prodFlow: new ObjectId('5607326b1b7251582490bc06'),
    workCenter: 'T2LED-6',
    prodLine: 'CT6'
  },
  newOrgUnits: {
