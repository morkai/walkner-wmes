...
db.kanbanentries.updateMany({componentQtyJit: {$exists: false}}, {$set: {componentQtyJit: 0}});

// Recount
// /fix/clip/count-daily-mrp?from=2016-12-01
// /fix/fteMasterEntries/recount-totals?date=2016-12-01
...
const toUpdate = [{
  oldOrgUnits: {
    ...
    mrpControllers: ['KH9'],
    prodFlow: new ObjectId('584435222b4295a7fb91ee59'),
    workCenter: 'OUTD4-4',
    prodLine: 'LM-4'
  },
  newOrgUnits: {
