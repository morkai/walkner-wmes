...
define([
  ...
  'app/behaviorObsCards/templates/reportTable',
  'app/behaviorObsCards/templates/tableAndChart'
], function(
  _,
  t,
  Highcharts,
  ...
  return View.extend({
    ...
    createChart: function()
    {
      ...
      this.chart = new Highcharts.Chart({
        ...
        exporting: {
          filename: t.bound('behaviorObsCards', 'report:filenames:' + metric),
          chartOptions: {
            title: {
              text: t.bound('behaviorObsCards', 'report:title:' + metric)
            },
            legend: {
              enabled: true
            }
    ...
    serializeChartSeries: function()
    {
      ...
      return Object.keys(series).map(function(seriesId)
      {
        ...
        return _.defaults(serie, {
          id: seriesId,
          type: 'column',
          name: serie.name || t.bound('behaviorObsCards', 'report:series:' + seriesId),
          data: []
        });
      });
    },
