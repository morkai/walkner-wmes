...
define([
  ...
  'app/wmes-oshAudits/templates/filter',
  ...
  return FilterView.extend({
    ...
    termToForm: {
      ...
      'anyNok': function(propertyName, term, formData)
      {
    ...
    serializeFormToQuery: function(selector)
    {
      ...
      var anyNok = this.getButtonGroupValue('anyNok');
      ...
      if (anyNok.length === 1)
      {
        selector.push({name: 'eq', args: ['anyNok', anyNok[0] === 'true']});
      }
