...
define([
  ...
  'app/viewport',
  'app/core/View',
  'app/wmes-drilling/templates/list'
], function(
  _,
  $,
  t,
  ...
  return View.extend({
    ...
    events: {
      'mousedown .drilling-list-item': function(e)
      {
        this.lastClickEvent = e;
      },
      'mouseup .drilling-list-item': function(e)
      {
    ...
    initialize: function()
    {
      ...
      this.listenTo(this.model, 'mrpSelected', this.toggleVisibility);
    },
    ...
    {
      return this.$('.drilling-list-item[data-order-id="' + orderId + '"]');
    },
    ...
    toggleVisibility: function()
    {
      ...
      this.$('.drilling-list-item').each(function()
      {
