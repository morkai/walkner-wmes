...
$inputPath = ReadIni("T_STATUSES", "InputPath", ReadIni("Transactions", "InputPath", "C:\SAP\Input"))
$inputFile = ReadIni("T_STATUSES", "InputFile", "T_STATUSES.txt")
$outputPath = ReadIni("T_STATUSES", "OutputPath", ReadIni("Transactions", "OutputPath", "C:\SAP\Output"))
$outputFile = ReadIni("T_STATUSES", "OutputFile", "T_STATUSES.txt")
$codePage = ReadIni("T_STATUSES", "OutputEncoding", ReadIni("Transactions", "OutputEncoding", "4110"))
$layout = ReadIni("T_STATUSES", "Layout", "T_STATUSES")

If $CmdLine[0] = 1 And $CmdLine[1] = "--help" Then
  LogDebug("T_STATUSES <arguments>")
  LogDebug()
  LogDebug("Arguments:")
  LogDebug("  --input-path")
  LogDebug("  --input-file")
