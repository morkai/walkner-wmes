...
module.exports = (app, module) =>
{
  ...
  const strategy = new AzureAdOAuth2Strategy(module.config.office365.strategy, handleLogin);
  const proxy = process.env.https_proxy || process.env.http_proxy;

  if (proxy && strategy._oauth2)
  {
  ...
  express.get('/auth/office365', (req, res, next) =>
  {
    ...
    {
      res.cookie('users.returnUrl', req.query.returnUrl, {
        httpOnly: true,
        secure: false,
        sameSite: 'lax'
      });
  ...
  express.get(
    ...
    {
      const options = {proxy: true, session: false};
