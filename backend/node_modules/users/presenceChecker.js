...
module.exports = (app, module) =>
{
  ...
  function checkPresence()
  {
    step(
      function()
      {
        settings.findValues({_id: /^users\.presence\./}, 'users.presence.', this.next());
      },
      ...
      function()
      {
        ...
        this.conn.on('error', err => module.error(err, {submodule: 'presenceChecker'}));
      ...
      function(err)
      {
        ...
        if (err)
        {
          module.error(err, `Failed to check.`, {submodule: 'presenceChecker'});
