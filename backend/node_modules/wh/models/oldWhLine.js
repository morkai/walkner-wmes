...
exports.setUp = (app, mongoose) =>
{
  ...
  lineSchema.statics.startNewSet = async function(setOrders, session)
  {
    ...
    for (const lineId of lineIds)
    {
      ...
      const addedLine = (new WhLine({_id: lineId})).toObject();

      addedSet.add(addedLine);
      lineList.push(addedLine);
      lineMap.set(lineId, addedLine);
    }
    ...
    planDoneOrders.forEach((whOrder, i) =>
    {
      ...
      const operation = operations.get(line._id);
