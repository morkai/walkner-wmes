...
exports.setUp = (app, mongoose) =>
{
  ...
  orderSchema.methods.checkProblemChange = function(oldStatus, messages)
  {
    if (this.status === oldStatus || (this.status !== 'problem' && oldStatus !== 'problem'))
    {
      return messages;
    }
    ...
    {
      messages.push({
        topic: `old.wh.problems.${line._id}.${this.order}`,
        message: {
          line: line._id,
          order: this.order,
          state: this.status === 'problem'
        }
      });
    });
