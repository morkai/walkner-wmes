...
exports.setUp = (app, mongoose) =>
{
  ...
  setCartSchema.statics.updateByFunc = async function(whOrder, funcId)
  {
    ...
    if (kind === 'components')
    {
      const fmx = whOrder.funcs.find(func => func._id === 'fmx');
      const kitter = whOrder.funcs.find(func => func._id === 'kitter');
      const platformer = whOrder.funcs.find(func => func._id === 'platformer');
    ...
    {
      func = whOrder.funcs.find(func => func._id === funcId);
    }
