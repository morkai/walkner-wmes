  ...
  function findNextPendingOrder(date, done)
  {
    step(
      function findLastProblemLineStep()
      {
        ...
        // TODO remove
        settingsModule.findById('planning.wh.newIncludedMrps', this.parallel());
      },
  ...
  function findMorePendingOrders(pendingOrder, done)
  {
    ...
    step(
      ...
      function(err, settings)
      {
        ...
        this.groupDuration = (settings.groupDuration || 2) * 3600 * 1000;
        this.minSetDuration = (settings.minSetDuration || 120) * 60 * 1000;
        this.maxSetDuration = (settings.maxSetDuration || 120) * 60 * 1000;
        this.maxSetDifference = (settings.maxSetDifference || 120) * 60 * 1000;
      ...
      function(err, psOrders)
      {
        ...
        while (whOrders.length && set.length < this.maxSetSize)
        {
          ...
          // Order fits in the group's boundaries.
          ...
          // Max set duration exceeded, don't extend.
          if (setDuration + orderDuration > this.maxSetDuration)
          {
            if (log) log('stop: max set duration');
