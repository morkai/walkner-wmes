...
module.exports = function setUpWhState(app, module)
{
  ...
  function findNextPendingOrder(date, done)
  {
    step(
      ...
      {
        findLastProblemLine(date, this.next());
      },
      function findNextPendingOrderStep(err, problemLine)
      {
        if (err)
        {
          return this.skip(err);
        ...
        tryFindNextPendingOrder(date, problemLine, [], this.next());
      },
      function findNextNoProblemPendingOrderStep(err, whOrder)
      {
        if (err)
        {
          ...
          {
            return tryFindNextPendingOrder(date, null, [], this.next());
          }
        }
  ...
  function tryFindNextPendingOrder(date, line, ignore, done)
  {
    step(
      function()
      {
      ...
      function(err)
      {
        ...
        setImmediate(tryFindNextPendingOrder, date, line, ignore, done);
      }
    );
  }
