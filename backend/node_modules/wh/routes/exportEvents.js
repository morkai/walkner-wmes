...
module.exports = (app, module, req, res, next) =>
{
  ...
  function serializeRow(doc)
  {
    ...
    {
      if (data.oldDeliveredOrder && data.oldDeliveredOrder.status)
      {
        oldStatus = data.oldDeliveredOrder.status;
      }

      if (data.newDeliveredOrder && data.newDeliveredOrder.status)
      {
        newStatus = data.newDeliveredOrder.status;
      }

      if (data.newDeliveredOrder && typeof data.newDeliveredOrder.qtyDone === 'number')
      {
