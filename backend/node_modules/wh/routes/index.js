...
const exportSetCartsRoute = require('./exportSetCarts');
const exportDowntimesRoute = require('./exportDowntimes');
...
module.exports = (app, module) =>
{
  ...
  express.get('/old/wh/orders;export.:format?', canView, exportOrdersRoute.bind(null, app, module));
  ...
  express.get('/old/wh/downtimes;export.:format?', canView, exportDowntimesRoute.bind(null, app, module));
  ...
  express.get('/old/wh/setCarts;export.:format?', canView, exportSetCartsRoute.bind(null, app, module));
