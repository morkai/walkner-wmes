...
module.exports = (app, module) =>
{
  ...
  express.get('/old/wh/events;export.:format?', canView, prepareEventFilter, exportRoute.bind(null, app, module));
  ...
  function prepareLines(totalCount, collection, formatResult)
  {
    step(
      function()
      {
      ...
      function(err, plannedLineList)
      {
        ...
        formatResult(null, {totalCount, collection});
      }
    );
  }
