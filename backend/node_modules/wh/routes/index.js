...
module.exports = (app, module) =>
{
  ...
  const canView = user.auth('LOCAL', 'WH:VIEW', 'PAINT_SHOP:VIEW');
  ...
  // Plans
  express.post('/old/wh/plans/:id;generate', canManage, generateRoute);
  express.post('/old/wh/plans/:id;act', canUpdate, actRoute);
  ...
  express.post('/old/wh/downtimes', canManage, express.crud.addRoute.bind(null, app, WhDowntime));
  express.get('/old/wh/downtimes/:id', canView, express.crud.readRoute.bind(null, app, WhDowntime));
  express.put('/old/wh/downtimes/:id', canManage, express.crud.editRoute.bind(null, app, WhDowntime));
  express.delete('/old/wh/downtimes/:id', canManage, express.crud.deleteRoute.bind(null, app, WhDowntime));
