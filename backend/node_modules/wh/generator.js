    ...
    step(
      ...
      function()
      {
        ...
        if (this.lines.size)
        {
          ...
          WhLine.collection.insertMany(lines, {ordered: false, w: 'majority'}, (err) =>
          {
        ...
        if (added.length)
        {
          ...
          WhOrder.collection.insertMany(added, {ordered: false, w: 'majority'}, (err, res) =>
          {
        ...
        if (removed.length)
        {
          WhOrder.collection.deleteMany({_id: {$in: removed}}, {w: 'majority'}, this.group());
        }

        changed.forEach(change =>
        {
          WhOrder.collection.updateOne({_id: change._id}, {$set: change}, {w: 'majority'}, this.group());
        });
      },
      function(err)
      {
