...
module.exports = (app, module) =>
{
  ...
  function tryGeneratePlan(state, done)
  {
    ...
    step(
      ...
      function()
      {
        ...
        // TODO remove after 8.9.2020
        if (state.date < new Date('2020-09-08T00:00:00.000Z'))
        {
          conditions.statuses = {
  ...
  function compareOrders(oldOrder, newOrder)
  {
    ...
    {
      if (oldOrder.distStatus !== 'pending' && IGNORE_DELIVERED_PROPS[p])
      {
        return;
      }
  ...
  function combineOrder(whOrders, groupExtraItems)
  {
    ...
    if (lastPart.qty <= groupExtraItems)
    {
      ...
      prevPart.lines.forEach(function(line, i)
      {
    ...
    if (firstPart.qty <= groupExtraItems)
    {
      ...
      if (nextPart)
      {
        ...
        nextPart.lines.forEach(function(line, i)
        {
