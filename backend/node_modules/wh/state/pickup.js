...
exports.execute = async (app, module, {data, user, session}) =>
{
  ...
  switch (newValue)
  {
    ...
    case 'failure':
    {
      ...
      pickupEvent.problemArea = data.problemArea;
      pickupEvent.comment = data.comment;
  ...
  const [setCartsResults, eventsResults] = await Promise.all([
    ...
    WhEvent.record([pickupEvent], session),
    newValue === 'success' || newValue === 'failure'
