...
module.exports = async (app, module, {data, user, whUser, session}) =>
{
  ...
  const pendingSets = pendingDelivery ? [] : await findPendingSets(pendingComponentsResult);
    ...
    now)
  {
    ...
    allAvailableSetCarts.forEach(lineSetCarts =>
    {
      ...
      lineSetCarts.carts.forEach(cart =>
      {
        ...
        if ((cartStartTime - now) < maxDeliveryStartTime || isAnyLineWorking(cart.lines, workingLines))
        {
