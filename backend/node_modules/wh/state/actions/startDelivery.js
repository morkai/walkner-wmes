...
module.exports = async (app, module, {data, user, whUser, session}) =>
{
  ...
  async function fillRemainingSetCarts()
  {
    ...
    const lineStats = createDeliveredOrders(allNewWhOrders, blockedLineOrders);
  ...
  async function findAvailableLines()
  {
    ...
    {
      conditions['components.time'] = {$lt: minTimeForDelivery};
    }
  ...
  function createDeliveredOrders(allNewWhOrders, blockedLineOrders)
  {
