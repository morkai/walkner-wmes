...
module.exports = async (app, module, {data, user, whUser, session}) =>
{
  ...
  async function updateLines(lineStats)
  {
    ...
    whLines.forEach(whLine =>
    {
      ...
      whLine.pickup.finished.qty = Math.max(0, whLine.pickup.finished.qty - stats.qty);
      whLine.pickup.finished.time = Math.max(0, whLine.pickup.finished.time - stats.time);
