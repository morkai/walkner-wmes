...
exports.execute = async (app, module, {data, user, whUser, session}) =>
{
  ...
  async function fillRemainingSetCarts()
  {
    ...
    const workingLines = forcedSetCarts.length ? [] : findWorkingLines(availableLines);
    const availableSetCarts = await findAvailableSetCarts(availableLines, workingLines, forcedSetCarts);
