...
module.exports = async (app, module, {data, user, whUser, session}) =>
{
  ...
  {
    const fmxIndex = WhOrder.FUNCS.indexOf('fmx');
    const kitterIndex = WhOrder.FUNCS.indexOf('kitter');

    activeOrderConditions[`funcs.${fmxIndex}.pickup`] = 'success';
    activeOrderConditions[`funcs.${kitterIndex}.status`] = 'finished';
  }
