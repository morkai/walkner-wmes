...
module.exports = async (app, module, {data, user, whUser, session}) =>
{
  ...
  if (!Array.isArray(deliveryFuncs) || !deliveryFuncs.includes(whUser.func))
  {
    throw app.createError('Invalid delivery function.', 'INPUT', 400);
  }
  ...
  return await startDelivery(app, module, {
