...
<div class=page>
  <div class=hd>
    <div class=title>Picklista malarnii <span class=page-no><%- orderI + 1 %>/<%- orders.length %></span></div>
    <div class=props>
      <div class=prop>
  ...
  <div class=bd>
    <div class=props>
      ...
      <div class=prop>
        <div class=prop-name>Linia</div>
        <div class=prop-value><%- line %></div>
      </div>
    </div>
    <div class=props>
      <div class=prop>
        <div class=prop-name>Zlecenie</div>
        <div class=prop-value><%- order.orderNo %></div>
      </div>
      <div class=prop>
        <div class=prop-name>12NC</div>
        <div class=prop-value><%- order.nc12 %></div>
      </div>
      <div class=prop>
        <div class=prop-name>Nazwa</div>
        <div class="prop-value wrap"><%= order.name %></div>
      </div>
    </div>
    <div class="subtitle">Komponenty</div>
    <table class=orders>
      <thead>
        <tr>
          <td></td>
      ...
      <tbody>
        ...
        <tr class=order-comments>
          <td colspan=4><%= order.comments.join('<br>') %></td>
        </tr>
      </tbody>
    </table>
  </div>
