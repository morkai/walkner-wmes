...
exports.setUp = (app, mongoose) =>
{
  ...
  prodShiftOrderSchema.index({'orderData.nc12': 1, startedAt: -1});
  ...
  prodShiftOrderSchema.post('remove', function(doc)
  {
    if (app.production.recreating)
    {
      return;
  ...
  prodShiftOrderSchema.methods.recalcCycleTime = function(done)
  {
  ...
  prodShiftOrderSchema.methods.getOperation = function()
  {
    return this.orderData && this.orderData.operations && this.orderData.operations[this.operationNo] || null;
  };

  prodShiftOrderSchema.methods.getTaktTimeCoeff = function()
  {
    const taktTimeCoeffs = this.orderData && this.orderData.taktTimeCoeff;
  ...
  mongoose.model(exports.name, prodShiftOrderSchema);
};
