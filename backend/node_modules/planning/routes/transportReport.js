...
const transportReport = require('../reports/transport');
...
module.exports = (app, {reports}, req, res, next) =>
{
  ...
  const days = _.isEmpty(query.days) ? [] : query.days.split(',');

  if (!days.length && (!fromMoment.isValid() || !toMoment.isValid()))
  {
  ...
  reports.generateResponse(transportReport, options, req, res, next);
};
