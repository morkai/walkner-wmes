...
module.exports = function browseSapOrdersRoute(app, {Order, OrderEto, Plan}, req, res, next)
{
  const mrp = _.isString(req.query.mrp) && /^[A-Za-z0-9]{1,10}$/.test(req.query.mrp)
    ? req.query.mrp
    : null;
  ...
  step(
    ...
    function(err, orderEtos)
    {
      if (err)
      {
        module.error(err, `Failed to read order ETO.`);
      }
