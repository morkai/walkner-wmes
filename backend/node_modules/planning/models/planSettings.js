...
exports.setUp = (app, mongoose) =>
{
  ...
  planSettingsSchema.statics.createNew = function(_id)
  {
    return new this({
      ...
      ignoredStatuses: ['CNF', 'DLV', 'TECO', 'DLFL', 'DLT'],
      completedStatuses: ['CNF', 'DLV', 'TECO', 'DLFL', 'DLT'],
      ignoredWorkCenters: [],
      schedulingRate: {},
      freezeHour: 0,
      lateHour: 6,
      etoPilotHour: 6,
      minIncompleteDuration: 0,
      lines: [],
      mrps: []
    });
  };
  ...
  planSettingsSchema.statics.copyFrom = function(_id, sourceSettings)
  {
    return new this({
      ...
      minIncompleteDuration: sourceSettings.minIncompleteDuration,
  ...
  planSettingsSchema.methods.toGenerator = function(taktTimeCoeffs)
  {
    ...
    return {
      ...
      minIncompleteDuration: this.minIncompleteDuration * 60 * 1000,
