...
exports.setUp = (app, mongoose) =>
{
  const planOrderSchema = new mongoose.Schema({
    ...
    kind: {
      type: String,
      enum: ['unclassified', 'small', 'medium', 'big', 'easy', 'hard']
    },
    date: String,
    mrp: String,
    nc12: String,
  ...
  planSchema.statics.BROWSE_LIMIT = 50;
  ...
  planSchema.statics.createPlanOrder = function(source, sapOrder)
  {
  ...
  mongoose.model(exports.name, planSchema);
};
