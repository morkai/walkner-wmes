...
exports.report = (app, module, options, done) =>
{
      ...
      function()
      {
        ...
        this.lineOrders.forEach((lineOrders, line) =>
        {
          ...
          lineOrders.forEach(lineOrder =>
          {
            ...
            const execution = getLineOrderExecution(
              this.shiftOrders[line] || [],
              lineOrder,
              planOrder,
              workingTimes,
  ...
  function getLineOrderExecution(shiftOrders, lineOrder, planOrder, workingTimes, cache)
  {
    const execution = {
    ...
    const qtyPlan = lineOrder.quantity;
