...
<div id="columns">
  <div class="column">
    <table>
      ...
      <tr>
        <td class="item min"><%- component.item %></td>
...
<script>
  ...
  var PADDING = 15;
  var HEADER_HEIGHT = document.getElementById('hd').getBoundingClientRect().height;
  var NOTES_HEIGHT = document.getElementById('notes').getBoundingClientRect().height;
  ...
  function resize()
  {
    ...
    var availableHeight = window.innerHeight - thHeight - (PADDING * 2) - HEADER_HEIGHT - NOTES_HEIGHT - 5;
