...
module.exports = (app, module, req, res, next) =>
{
  ...
  module.findDocumentFilePath(nc15, options, (err, results) =>
  {
    ...
    {
      if (!_.isEmpty(results.meta) && results.type === 'application/pdf')
      {
        return res.render('orderDocuments:viewer/pdf', {
          nc15,
          hash: results.hash,
          meta: results.meta,
          name: results.name
      ...
      if (results.type === 'video/mp4')
      {
        return res.render('orderDocuments:viewer/video', {
          orderNo,
          nc15,
          hash: results.hash,
          name: results.name
      ...
      if (results.type.startsWith('image/'))
      {
        return res.render('orderDocuments:viewer/image', {
          orderNo,
          nc15,
          hash: results.hash,
          meta: results.meta,
