...
module.exports = (app, module, nc15, options, done) =>
{
  ...
  step(
    ...
    function(err, orderDocumentFile, order)
    {
      ...
      const orderDate = order ? (order.sapCreatedAt || order.salesOrderDate || order.scheduledStartDate) : null;
      const orderTime = orderDate
        ? moment(orderDate).utc(true).valueOf()
        : shifts.getCurrentDate(true).valueOf();
      let file = null;
