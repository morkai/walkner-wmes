  ...
  function convertNext()
  {
    ...
    step(
      ...
      function ensureDirStep(err, todo)
      {
        ...
        module.info(`[converter] Start hash=[${todo._id}] nc15=${todo.nc15} count=${todo.count}...`);
      ...
      function(err, tryNext)
      {
        if (err)
        {
          ...
          module.error(err, `[converter] Failed to convert.`);
        ...
        else if (this.todo)
        {
          ...
          this.todo.remove(err =>
          {
            if (err)
            {
              module.error(err, `[converter] Failed to remove: ${this.todo._id}`);
            }
