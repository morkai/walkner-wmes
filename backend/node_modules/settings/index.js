...
exports.start = (app, module) =>
{
  ...
  module.update = (_id, newValue, updater, done) =>
  {
    ...
    function doUpdate(resolve, reject)
    {
      ...
      SettingChange.collection.insertOne(change, err =>
      {
        if (err)
        {
          module.error(err, 'Failed to record a setting change.', {change});
        }
      });
