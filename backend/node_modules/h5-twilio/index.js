...
exports.start = (app, module) =>
{
  ...
  function sms(smsOptions, done, retryCount)
  {
    ...
    twilioRequest.save((err) =>
    {
      ...
      if (module.config.transliterateSms && messageOptions.body)
      {
        messageOptions.body = transliterate(messageOptions.body, {unknown: '?'});
      }

      if (module.config.maxSmsLength > 0
        && messageOptions.body
        && messageOptions.body.length > module.config.maxSmsLength)
      {
        messageOptions.body = messageOptions.body.substring(0, module.config.maxSmsLength - 3) + '...';
      }
