...
function MongoStore(db, options)
{
   ...
   * @type {number}
   */
  this.touchChance = options.touchChance >= 0 ? options.touchChance : MongoStore.Options.touchChance;

  /**
   * @private
   * @type {number}
   */
  this.touchInterval = options.touchInterval >= 0 ? options.touchInterval : MongoStore.Options.touchInterval;
