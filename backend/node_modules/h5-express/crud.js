...
exports.exportRoute = (app, options, req, res, next) =>
{
  ...
  function initializeXlsx()
  {
    ...
    jsonToXlsx.stdout.on('data', data =>
    {
      if (!app.express.exports[exportId])
      {
      ...
      app.express.exports[exportId].outputFile += data;
    });
  ...
  {
    const config = {
      outputFile: path.join(os.tmpdir(), `WMES_EXPORT__${exportId}.xlsx`),
...
function setUpExports(app)
{
  ...
  app.express.get('/express/exports/:id', (req, res, next) =>
  {
    ...
    res.download(xport.outputFile.trim(), xport.filename, () =>
    {
...
function cleanUpExport(app, exportId)
{
  ...
  fs.unlink(app.express.exports[exportId].outputFile.trim(), () => {});

  delete app.express.exports[exportId];
}
