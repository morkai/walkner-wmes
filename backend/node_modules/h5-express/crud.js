...
exports.browseRoute = (app, options, req, res, next) =>
{
  ...
  step(
    ...
    function sendResponseStep(err, collection)
    {
      ...
      if (collection.length > 0 && typeof options.prepareResult === 'function')
      {
        options.prepareResult(totalCount, collection, formatResult, req);
      }
      else
      {
        formatResult(null, {
...
exports.readRoute = (app, options, req, res, next) =>
{
  ...
  function handleModel(err, model)
  {
    ...
    {
      options.prepareResult(model, formatResult, req);
    }
    else
    {
