...
module.exports = (app, module) =>
{
  ...
  function updatePsStatus(paintShopEvent, done)
  {
    ...
    step(
      ...
      function(err, psOrders)
      {
        ...
        else if (statuses.startedMsp)
        {
          newStatus = 'startedMsp';
        }
        else if (statuses.aside === psOrders.length)
        {
          newStatus = 'aside';
        }
  ...
  {
    const changedPsOrders = [];

    changes.added.forEach(o => changedPsOrders.push(o._id));
    changes.changed.forEach(o => changedPsOrders.push(o._id));
