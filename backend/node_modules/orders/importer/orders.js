...
exports.start = (app, module) =>
{
  ...
  )
  {
    ...
    if (different)
    {
      ...
      {
        const oldStatus = _.pick(changes.oldValues.statuses, COMPLETED_ORDER_STATUSES);
        const newStatus = _.pick(changes.oldValues.statuses, COMPLETED_ORDER_STATUSES);

        if (_.intersection(oldStatus, newStatus).length === 0)
        {
