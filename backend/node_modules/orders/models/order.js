...
exports.setUp = (app, mongoose) =>
{
  ...
  orderSchema.statics.COMPLETED_STATUSES = ['CNF', 'DLV', 'TECO', 'DLT', 'DLFL'];
  ...
  orderSchema.statics.assignCompRelEntries = function(order, done)
  {
    ...
    step(
      function()
      {
        CompRelEntry
          ...
          .select({
            ...
            newName: 1,
            reason: 1,
            orders: {$elemMatch: {_id: order._id}}
          })
          .lean()
          .exec(this.next());
      },
      function(err, compRelEntries)
      {
        ...
        {
          entry.releasedBy = entry.orders[0].releasedBy;
          entry.releasedAt = entry.orders[0].releasedAt;
