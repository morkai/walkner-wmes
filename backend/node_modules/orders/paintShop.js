...
module.exports = (app, module) =>
{
  ...
  function updatePsStatus(paintShopEvent, done)
  {
    ...
    step(
      ...
      function(err, psOrders)
      {
        ...
        {
          eventChange.comment = this.defaultComment;
        }
  ...
  function updateNextPsStatus(psEvent, sapOrderQueue)
  {
    psEvent.order = sapOrderQueue.shift();

    if (psEvent.order)
    {
      updatePsStatus(psEvent, () => updateNextPsStatus(psEvent, sapOrderQueue));
    }
  }
};
