...
exports.start = (app, module, done) =>
{
  ...
  function setUpEventListeners()
  {
    ...
    module.client.on('reconnect', () => module.info('Reconnected.'));
    module.client.on('authenticated', () => module.info('Authenticated.'));
  }
  ...
  function setUpKeepAliveQuery()
  {
    ...
    module.db.stats((err, stats) =>
    {
      ...
      else
      {
        if (keepAliveFailed)
        {
          module.info(`Kept alive: ${JSON.stringify(stats)}`);
        }
