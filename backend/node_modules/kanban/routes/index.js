...
const splitEntryRoute = require('./splitEntry');
...
module.exports = function setUpKanbanRoutes(app, module)
{
  ...
  const canUpdateSettings = userModule.auth('KANBAN:MANAGE', 'FN:whman', 'FN:wh');
  ...
  express.post('/kanban/entries/:id;split', canImport, splitEntryRoute.bind(null, app, module));
