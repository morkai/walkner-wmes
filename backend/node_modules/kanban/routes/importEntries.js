...
module.exports = function importEntriesRoute(app, module, req, res, next)
{
  ...
  step(
    ...
    function()
    {
      ...
      const addresses = {
        _id: null,
        kind: null,
        workstations: [null, null, null, null, null, null, null, null, null, null],
        container: null,
        locations: [null, null, null, null, null, null, null, null, null, null],
        discontinued: null
      };
  ...
  function parseCellValue(column, cell)
  {
    ...
    {
      case '_id':
        return cell && /^[0-9]{1,10}[a-z]?$/.test(String(cell.v)) ? String(cell.v) : null;
