...
module.exports = (app, module) =>
{
  ...
  function confirmOldProdDowntimes()
  {
    ...
    module.info(`Confirming downtimes older than ${autoConfirmHours} hours...`);
    ...
    step(
      ...
      function finalizeStep(err)
      {
        ...
        if (err)
        {
          module.error(err, 'Failed to confirm old downtimes.');
        }
        else if (this.count > 0)
        {
          module.info(`Confirmed ${this.count} downtimes older than ${autoConfirmHours} hours!`);
        }
