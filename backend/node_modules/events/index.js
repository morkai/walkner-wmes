...
exports.DEFAULT_CONFIG = {
  ...
  collection: (app) =>
  {
    if (app.mongoose)
    {
      return app.mongoose.model('Event').collectio;
    }

    if (app.mongodb)
    {
      return app.mongodb.db.collection('events');
    }

    throw new Error('No mongoose or mongodb module!');
  },
  insertDelay: 1000,
  topics: ['events.**'],
  blacklist: [],
...
exports.republishTopics = ['events.saved'];

exports.userPrivileges = ['EVENTS:VIEW', 'EVENTS:MANAGE'];
...
exports.start = (app, module) =>
{
  ...
  function queueEvent(severity, data, topic)
  {
    ...
    const user = !_.isObject(userData) ? null : {
