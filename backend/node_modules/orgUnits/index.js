...
exports.modelPlugins = {
  ...
  {
    userSchema.path('orgUnitType', {
      type: String,
      enum: ['division', 'subdivision', 'unspecified'],
      default: 'unspecified'
    });

    userSchema.path('orgUnitId', {
      type: String,
      default: null
    });
    ...
    {
      user.orgUnitType = 'unspecified';
      user.orgUnitId = null;
    });

    userSchema.statics.EDITABLE_PROPERTIES.orgUnitType = true;
    userSchema.statics.EDITABLE_PROPERTIES.orgUnitId = true;
  }
};
  ...
  function rebuildCache()
  {
    ...
    steps.push(function()
    {
      if (rebuildingCache === 1)
      {
        ...
        module.info(`Rebuilt cache in ${t} ms.`);
