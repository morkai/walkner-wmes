...
module.exports = function setUpXiconfResultsImporter(app, xiconfModule)
{
  ...
  function enqueueFile(fileInfo)
  {
    ...
    xiconfModule.info('Queued %s...', fileInfo.fileName);
  ...
  {
    xiconfModule.info('Importing %s...', fileInfo.fileName);
  ...
  function validateLicenseStep(err)
  {
    ...
    {
      xiconfModule.info('Failed to decrypt the UUID: %s', err.message);
  ...
  function updateModelsStep()
  {
    ...
    xiconfModule.info('Updating the models (%d orders, %d results)...', this.orders.length, this.results.length);
  ...
  function saveFeatureFilesStep(err)
  {
    ...
    xiconfModule.info('Saving %d feature file(s)...', this.featureFiles.length);
