...
{
  const {express, user, IcpoResult} = module;

  const canView = user.auth('ICPO:VIEW');

  express.post('/icpo;import', importRoute.bind(null, app, module));
  ...
  express.get(
    ...
    canView,
    downloadRoute.bind(null, 'order', module, IcpoResult)
  );

  express.get(
    '/icpo/results/:id;driverData',
    canView,
    downloadRoute.bind(null, 'driver', module, IcpoResult)
  );

  express.get(
    '/icpo/results/:id;gprsData',
    canView,
    downloadRoute.bind(null, 'gprs', module, IcpoResult)
  );

  express.get(
    '/icpo/results/:id;inputData',
    canView,
    downloadRoute.bind(null, 'input', module, IcpoResult)
  );

  express.get(
    '/icpo/results/:id;outputData',
    canView,
    downloadRoute.bind(null, 'output', module, IcpoResult)
  );
  ...
  function readFiles(icpoResult, done)
  {
    ...
    step(
      function()
      {
        const fileStoragePath = module.config.fileStoragePath;
  ...
  function findDistinctSrcIds(totalCount, models, done)
  {
    ...
    IcpoResult.distinct('srcId', (err, srcIds) =>
    {
      if (err)
      {
        return done(err);
