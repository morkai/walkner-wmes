...
exports.start = (app, module) =>
{
  ...
  function queueFile(fileInfo)
  {
    ...
    module.debug(`Queued...`, {key: fileInfo.timeKey});
  ...
  function importNext()
  {
    ...
    module.debug(`Importing...`, {key: fileInfo.timeKey});
    ...
    importFile(fileInfo, function(err, count)
    {
      ...
      if (err)
      {
        module.error(err, 'Import failed.', {key: fileInfo.timeKey});
  ...
  function importFile(fileInfo, done)
  {
    step(
      ...
      function parseFileStep(err, fileContents)
      {
        ...
        module.debug(`Parsing...`, {key: fileInfo.timeKey, fileSize: fileContents.length});
