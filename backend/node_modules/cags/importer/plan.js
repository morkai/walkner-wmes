...
exports.start = (app, module) =>
{
  ...
  function importNext()
  {
    ...
    importFile(fileInfo, function(err, count)
    {
      ...
      {
        module.debug('Imported.', {count, duration: Date.now() - startTime});
  ...
  function importFile(fileInfo, done)
  {
    step(
      ...
      {
        module.debug('Parsing...', {filePath: fileInfo.filePath});
      ...
      function updateDbStep(err, cagPlans)
      {
        ...
        module.debug('Parsed!', {count: cagPlans.length, duration: Date.now() - this.t});
