...
exports.setUp = (app, mongoose) =>
{
  ...
  pfepEntrySchema.index({nc12: 1});
  pfepEntrySchema.index({packType: 1});
  pfepEntrySchema.index({vendor: 1});
  pfepEntrySchema.index({'creator.id': -1});
  pfepEntrySchema.index({createdAt: -1});
  ...
  mongoose.model(exports.name, pfepEntrySchema);
};
