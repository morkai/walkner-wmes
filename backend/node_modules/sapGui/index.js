...
exports.start = (app, module) =>
{
  ...
  function runScript(job, scriptFile, args, done)
  {
    ...
    {
      if (err && err.code === 'SCRIPT_TIMEOUT' && sessionId)
      {
  ...
  function runJob(job, repeatCounter, done)
  {
    ...
    if (job.workerJobId)
    {
      module.workerJobIds.add(job.workerJobId);
    }
  ...
  function handleJobResult(done, job, startedAt, err, exitCode, output)
  {
    ...
    setTimeout(() => module.workerJobIds.delete(job.workerJobId), 10000);
  }
