...
const EXIT_CODES = {
  1: 'NO_LOGON_WINDOW',
  2: 'NO_FRONTEND_WINDOW',
  3: 'NO_ROT_WRAPPER',
  4: 'NO_SAPGUI',
  5: 'NO_SCRIPTING_ENGINE',
  6: 'NO_CONNECTION',
  7: 'NO_SESSION',
  8: 'NO_FREE_SESSIONS',
  10: 'LOGON_WINDOW_LOCKED',
  11: 'INVALID_CREDENTIALS',
  12: 'NO_MAIN_WINDOW',
  13: 'MISSING_ARGUMENTS',
  14: 'NON_EMPTY_SBAR',
  15: 'NO_DATA',
  16: 'INVALID_SCREEN',
  17: 'MISSING_FILE'
...
exports.start = (app, module) =>
{
  ...
  function runScript(job, scriptFile, args, done)
  {
    if (!done)
    {
      return new Promise((resolve, reject) =>
      {
        runScript(job, scriptFile, args, (err, exitCode, output) =>
        {
          if (!err && exitCode)
          {
            err = new Error(`Non-zero exit code: ${EXIT_CODES[exitCode] || exitCode}`);
          }
  ...
  function runNextScript()
  {
    ...
    if (restarting)
    {
      return bail(app.createError('Restarting SAP GUI...', 'RESTARTING', 500), null);
    }
