  ...
  step(
    ...
    function(err, response, result)
    {
      ...
      if (result.dates.length)
      {
        ...
        result.dates.forEach(date => nextDate.push(date));
      }
      else
      {
  ...
  function runNext(done)
  {
    ...
    step(
      ...
      function(err, exitCode, output)
      {
        if (err)
        {
          sapGui.error(err, `Transaction failed.`, {jobId, date, exitCode, output});
  ...
  function runNextBatch(date, batches, count, totalCount, done)
  {
    ...
    step(
      ...
      function(err)
      {
        ...
        sapGui.runScript(job, 'T_DOCS.exe', args, checkOutputFile.bind(null, this.next()));
      },
      function(err, exitCode, output)
      {
        if (this.inputPath)
