  ...
  function runNext(done)
  {
    ...
    step(
      ...
      function(err, response, result)
      {
        ...
        runNextBatch(date, batches, 0, result.orders.length, this.next());
      },
  ...
  function runNextBatch(date, batches, count, totalCount, done)
  {
    step(
      function()
      {
        ...
        sapGuiModule.info(`[${job.id}] [${date}] Batch ${count}/${totalCount}...`);
      ...
      function(err, exitCode, output)
      {
        ...
        sapGuiModule.info(`[${job.id}] [${date}] Batch ${count}/${totalCount} done!`);
