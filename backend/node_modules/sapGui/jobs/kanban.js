  ...
  step(
    function()
    {
      this.result = {
        ...
        kanbans: {
          columns: ['_id', 'nc12', 'supplyArea', 'kanbanQtySap', 'componentQty', 'kanbanId', 'storageType'],
          rows: []
        },
        components: {
          columns: ['_id', 'description', 'storageBin', 'maxBinQty', 'minBinQty', 'replenQty', 'unit'],
          rows: []
        }
      };
    },
    ...
    function(err, pkhd)
    {
      ...
      parseSapTextTable(pkhd, {
        ...
        itemDecorator: obj =>
        {
          ...
          this.kanbans.set(obj._id.toString(), kanban);
          this.units.set(obj.nc12, obj.unit);
    ...
    function(err, pkps)
    {
      ...
      parseSapTextTable(pkps, {
        ...
        itemDecorator: obj =>
        {
          const kanban = this.kanbans.get(obj.controlCycleId.toString());
    ...
    function()
    {
      ...
      {
        component[6] = this.units.get(component[0]) || 'PCE';
      });
