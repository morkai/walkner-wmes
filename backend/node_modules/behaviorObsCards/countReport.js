...
exports.models = [
  require('./models/behaviorObsCard'),
  require('kaizen/models/kaizenSection'),
  require('user/models/user')
];

exports.report = (app, {BehaviorObsCard, KaizenSection, User}, options, done) =>
{
  ...
  step(
    ...
    function findBehaviorObsCardsStep()
    {
      ...
      if (options.anyHardObservations && options.anyHardRisks)
      {
        conditions.$or = [
          {anyHardObservations: true},
          {anyHardRisks: true}
        ];
      }
      else
      {
        if (options.anyHardObservations)
        {
          conditions.anyHardObservations = true;
        }

        if (options.anyHardRisks)
        {
          conditions.anyHardRisks = true;
        }
      }
