...
const editResultRoute = require('./editResult');
const sendResultPdfRoute = require('./sendResultPdf');
const sendResultHtmlRoute = require('./sendResultHtml');
const findByRidRoute = require('./findByRid');
const findOrderRoute = require('./findOrder');
const findComponentRoute = require('./findComponent');
const todoRoute = require('./todo');
const exportRoute = require('./export');
const countReportRoute = require('./countReport');
const okRatioReportRoute = require('./okRatioReport');
const nokRatioReportRoute = require('./nokRatioReport');
const outgoingQualityReportRoute = require('./outgoingQualityReport');
const outgoingQualityResultsRoute = require('./outgoingQualityResults');
const updateOqlWeekRoute = require('./updateOqlWeek');
const sendAttachmentRoute = require('./sendAttachment');
const uploadAttachmentsRoute = require('./uploadAttachments');
...
module.exports = (app, module) =>
{
  ...
  const canViewDictionaries = user.auth('QI:DICTIONARIES:VIEW', 'FACTORY_LAYOUT:MANAGE');
  const canManageDictionaries = user.auth('QI:DICTIONARIES:VIEW');
  const canViewResults = user.auth('QI:RESULTS:VIEW', 'FN:master', 'FN:leader', 'FN:manager', 'FN:wh');
  const canManageResults = user.auth('QI:INSPECTOR', 'QI:RESULTS:MANAGE', 'FN:leader', 'FN:wh');
  ...
  express.get('/qi/settings', canViewResults, settings.browseRoute('qi'));
  ...
  express.get('/qi/results;todo', canViewResults, todoRoute.bind(null, app, module));
