...
exports.report = (app, module, options, done) =>
{
  ...
  function countClip(mrpControllers, done)
  {
    ...
    report2.report(app, module, clipOptions, (err, clipResults) =>
    {
      done(err, clipResults ? clipResults.clip : null);
    });
  }
