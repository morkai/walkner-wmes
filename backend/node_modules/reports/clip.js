...
exports.report = (app, {mongoose}, options, done) =>
{
  ...
  step(
    ...
    function(err, settings)
    {
      ...
      fromLocal = addBusinessDays(moment(options.fromTime), options.findDatePropertyOffset);
      toLocal = addBusinessDays(moment(options.toTime), options.findDatePropertyOffset);
