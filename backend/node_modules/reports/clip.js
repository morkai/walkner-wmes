...
exports.report = (app, {mongoose}, options, done) =>
{
  ...
  step(
    ...
    function(err, settings)
    {
      ...
      fromLocal = moment(options.fromTime).add(options.findDatePropertyOffset, 'days');
      toLocal = moment(options.toTime).add(options.findDatePropertyOffset, 'days');
      fromUtc = moment.utc(fromLocal.format('YYYY-MM-DD'), 'YYYY-MM-DD');
      toUtc = moment.utc(toLocal.format('YYYY-MM-DD'), 'YYYY-MM-DD');
    ...
    function()
    {
      ...
      cursor.on('data', order =>
      {
        const dataTime = moment(order[options.dataDateProperty])
          .add(options.dataDatePropertyOffset, 'days')
