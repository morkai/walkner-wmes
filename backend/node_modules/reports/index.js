...
exports.start = (app, module) =>
{
  ...
  module.downloads = setUpDownloads(app, module);
  ...
  {
    const cachedReport = helpers.getCachedReport(report.id, req);
    ...
    req.setTimeout(helpers.GENERATE_REQUEST_TIMEOUT);
  ...
  app.broker.subscribe('settings.updated.reports.rearm.**', () =>
  {
    helpers.clearCachedReports('rearm');
  });
