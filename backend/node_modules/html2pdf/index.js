...
exports.start = (app, module) =>
{
  ...
  module.printPdf = (hash, printer, settings, done) =>
  {
    ...
    step(
      ...
      function(err, stats, printer)
      {
        ...
        {
          return handleDirectVersaLinkPrint(special.VERSALINK[0][0], pdfFilePath, this.next());
        }
  ...
  module.printZpl = (zpl, options, done) =>
  {
    ...
    step(
      function()
      {
        ...
        {
          module.Printer.findById(options.printer).lean().exec(this.parallel());
        }
      ...
      function(err, printer)
      {
        ...
        const linePrinter = findLinePrinter(parseSpecial(printer.special), options.line);
  ...
  function handleDirectVersaLinkPrint(printerHost, pdfFilePath, done)
  {
    const options = {
      url: `http://${printerHost}/UPLPRT.cmd`,
      formData: {
        DEFPRNT: '1',
