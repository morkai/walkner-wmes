...
module.exports = (app, module) =>
{
  ...
  app.broker.subscribe(`${CompRelEntry.TOPIC_PREFIX}.added`, message =>
  {
    handleAdd(message.model);
  });

  app.broker.subscribe(`${CompRelEntry.TOPIC_PREFIX}.updated.*`, message =>
  {
    handleUpdate(message._id, message.change);
  });
  ...
  function handleAdd(entry)
  {
    ...
    sendEmail(null, 'pending', recipients, entry);
  }
  ...
  function sendEmail(err, kind, recipients, entry)
  {
    step(
      function()
      {
      ...
      function(err, users, templateData)
      {
        ...
        {
          case 'pending':
            email.subject += `Wniosek oczekuje na opinię: ${entry.rid}`;
            break;
