...
const addFuncRoute = require('./addFunc');
...
module.exports = (app, module) =>
{
  ...
  const canBrowse = user.auth('LOCAL', 'PROD_DATA:VIEW', 'COMP_REL:VIEW');
  const canAdd = user.auth('PROD_DATA:MANAGE', 'COMP_REL:ADD', 'FN:logistic-buyer');
  ...
  express.get('/compRel/entries;export.:format?', canView, prepareFilter, exportRoute.bind(null, app, module));
  express.get(`/compRel/entries`, canBrowse, prepareFilter, express.crud.browseRoute.bind(null, app, CompRelEntry));
  ...
  express.post(`/compRel/entries/:id;add-func`, canView, addFuncRoute.bind(null, app, module));
  express.post(`/compRel/entries/:id;notify`, canView, notifyRoute.bind(null, app, module));
  express.get(`/compRel/entries/:id`, canView, express.crud.readRoute.bind(null, app, {
    model: CompRelEntry,
    prepareReadResult
  }));
  express.put(`/compRel/entries/:id`, canView, editEntryRoute.bind(null, app, module));
  express.patch(`/compRel/entries/:id`, canView, editEntryRoute.bind(null, app, module));
  ...
  async function prepareReadResult(model, formatResult)
  {
    const orders = new Map();

    model.orders.forEach(o =>
    {
      if (o.orderNo !== '000000000')
      {
        orders.set(o.orderNo, o);
      }
    });
    ...
    try
    {
      ...
      {
        const o = orders.get(sapOrder._id);

        o.productName = resolveProductName(sapOrder);
        o.productCode = sapOrder.nc12;
      });
