  ...
  function setUpSio()
  {
    ...
    sioModule.use((socket, done) =>
    {
      ...
      if (typeof sessionCookie !== 'string')
      {
        ...
        handshakeData.user = createGuestData(handshakeData);
    ...
    app.broker.subscribe('users.logout', (message) =>
    {
      ...
      {
        socket.handshake.sessionId = message.newSessionId;
        socket.handshake.user = createGuestData(socket.handshake);
    ...
    {
      handleUserEdit(usersToSocketsMap[message.model._id], message.model.toJSON());
    });
    ...
    {
      handleUserDelete(usersToSocketsMap[message.model._id], message.model._id);
    });
