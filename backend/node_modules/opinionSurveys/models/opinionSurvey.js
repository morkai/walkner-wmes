...
const LANG = {
  pl: {
    ...
    COMPANY: `{COMPANY}`,
    FOOTER_CLOSED: `Wszelkie prawa zastrzeżone.<br>Powielanie w całości lub w częściach bez zgody właściciela jest zabronione.`,
  ...
  ua: {
    ...
    COMPANY: `{COMPANY}`,
    FOOTER_CLOSED: `Всі права захищені.<br>Повторне відтворення повністю або частково без згоди власника заборонено.`,
