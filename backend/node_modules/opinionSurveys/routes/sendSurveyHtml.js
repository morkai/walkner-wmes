...
const COMPANY = {
  ketrzyn: {
    pl: `Philips Lighting Poland Oddział Kętrzyn`,
    ua: `Philips Lighting Poland Філією Kętrzyn`
  },
  pila: {
    pl: `Philips Lighting Poland Sp. z o.o.`,
    ua: `Philips Lighting Poland Sp. z o.o.`
  }
};
...
module.exports = (app, module, req, res, next) =>
{
  ...
  step(
    ...
    function(err, survey, divisions)
    {
      ...
      const company = companyLang[language] || companyLang.pl;
      ...
      else if (survey.lang && survey.lang[language])
      {
        templateData.survey = {...survey, ...survey.lang[language]};
      }
      else
      {
        templateData.survey = survey;
