...
const massUpdatePaintsRoute = require('./massUpdatePaints');
...
module.exports = (app, module) =>
{
  ...
  express.get('/r/dp/:filter/:job', redirectRoute.bind(null, app, module));
  ...
  express.post('/dummyPaint/paints;massUpdate', canManage, massUpdatePaintsRoute.bind(null, app, module));
