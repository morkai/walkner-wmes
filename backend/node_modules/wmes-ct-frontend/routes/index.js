...
module.exports = (app, module) =>
{
  ...
  const canDeleteBalancingPce = user.auth('PROD_DATA:MANAGE', 'FN:*process-engineer*');
  ...
  express.delete('/ct/balancing/pces/:id', canDeleteBalancingPce, deleteBalancingPceRoute.bind(null, app, module));
