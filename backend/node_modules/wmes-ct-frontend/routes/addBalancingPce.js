...
module.exports = async (app, module, req, res, next) =>
{
  ...
  const balancingPce = new CtBalancingPce({
    ...
    d: Date.parse(req.body.finishedAt) - Date.parse(req.body.startedAt),
    stt: 0,
    comment: ''
  });
  ...
  if (!Number.isSafeInteger(balancingPce.d))
  {
  ...
  try
  {
    ...
    if (order.sapTaktTime)
    {
      balancingPce.stt = Math.round(balancingPce.d / order.sapTaktTime * 100);
    }
