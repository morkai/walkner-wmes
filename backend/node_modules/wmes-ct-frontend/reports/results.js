...
exports.report = (app, {Setting, ProdShiftOrder, CtMrpConfig}, options, done) =>
{
  // TODO remove after frontend restart
  if (Array.isArray(options.ignoredMrps) && !options.ignoredMrps.length)
  {
    options.ignoredMrps = null;
  }
