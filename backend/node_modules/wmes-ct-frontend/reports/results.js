...
exports.report = (app, module, options, done) =>
{
  ...
  function handleShiftOrder(shiftOrder)
  {
    ...
    if (isUpphOrder(shiftOrder))
    {
      ...
      const num = shiftOrder.quantityDone / shiftOrder.workerCount / shiftOrder.workDuration;
      const numNorm = shiftOrder.quantityDone * coeff / shiftOrder.workerCount / shiftOrder.workDuration;

      results.upph.total[week][0] += num;
      results.upph.total[week][1] += 1;
      results.upph.total[week][2] += numNorm;
      results.upph.total[week][3] += 1;
      results.upph[mrp][week][0] += num;
      results.upph[mrp][week][1] += 1;
      results.upph[mrp][week][2] += numNorm;
