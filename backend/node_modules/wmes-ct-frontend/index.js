...
{
  const {CtTodo, CtLine, CtCart, CtBalancingPce} = module;
  ...
  app.broker.subscribe(`${CtCart}.*`, onCartChanged);
  app.broker.subscribe(`${CtLine}.*`, onLineChanged);
  app.broker.subscribe('settings.updated.ct.reports.results.**', onResultsReportSettingsChanged);
  app.broker.subscribe(`${CtBalancingPce}.updated`, onBalancingPceUpdated);
