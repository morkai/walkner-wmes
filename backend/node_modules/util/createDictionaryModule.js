...
module.exports = (setUpModel, setUpRoutes, customSetUp) =>
{
  return {
    ...
    start: (app, module, done) =>
    {
      ...
      app.broker.subscribe(`${Model.TOPIC_PREFIX}.added`, (message, topic, meta) =>
      {
      ...
      app.broker.subscribe(`${Model.TOPIC_PREFIX}.edited`, (message, topic, meta) =>
      {
        publishDictionaryUpdate(topic, message, meta);
      });

      app.broker.subscribe(`${Model.TOPIC_PREFIX}.deleted`, (message, topic, meta) =>
      {
        module.models = module.models.filter((model) => String(model._id) !== String(message.model._id));
...
function setUpDefaultRoutes(app, module, urlPrefix)
{
  ...
  express.put(`/${urlPrefix}/:id`, canManage, useDictionaryModel, express.crud.editRoute.bind(null, app, Model));
