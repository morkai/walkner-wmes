...
exports.setUp = (app, mongoose) =>
{
  ...
  pressWorksheetSchema.methods.createOrdersAndDowntimes = function(done)
  {
    ...
    _.forEach(this.orders, function(order)
    {
      ...
      const prodShiftOrder = {
        ...
        opWorkDuration: order.opWorkDuration,
      ...
      const subdivision = app.orgUnits.getByTypeAndId('subdivision', prodShiftOrder.subdivision);

      if (subdivision)
      {
        prodShiftOrder.subdivisionType = subdivision.type;
      }
      ...
      _.forEach(order.downtimes || [], function(downtime)
      {
        ...
        const prodDowntime = {
          ...
          operator: operator,
          operators: operators,
          subdivisionType: prodShiftOrder.subdivisionType,
          mechOrder: true,
  ...
  {
    const subdivision = app.subdivisions ? app.subdivisions.modelsById[subdivisionId] : null;
  ...
  mongoose.model(exports.name, pressWorksheetSchema);
};
