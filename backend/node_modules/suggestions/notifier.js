...
module.exports = (app, module) =>
{
  ...
  function notifyAboutAdd(suggestion)
  {
    ...
    {
      coordSection.users.forEach(user =>
      {
  ...
  function notifyAboutEdit(suggestion)
  {
    ...
    if (lastChange.kom && lastChange.kom[1])
    {
      const email = {
        to: new Map(),
        subject: `[WMES] [Usprawnienia] Kaizen Miesiąca: ${suggestion.rid}`,
        html: '',
        kom: true
      };
    ...
    step(
      function findNewSectionsStep()
      {
        ...
        lastChange.coordSections[1].forEach(coordSection =>
        {
          if (!diffSections.includes(coordSection._id))
          {
            return;
          }
      ...
      function sendEmailStep(err, templateData)
      {
        ...
        emails.forEach(email =>
        {
          ...
          if (email.to.length)
          {
            templateData.kom = !!email.kom;

            email.html = renderEmail(templateData);
