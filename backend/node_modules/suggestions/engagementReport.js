...
exports.report = (app, module, options, done) =>
{
  ...
  function handleNearMiss(doc)
  {
    ...
    getGroup(groupKey, TOTAL_USER, doc.section).nearMisses += 1;
  ...
  function handleSuggestion(doc)
  {
    ...
    const totalGroup = getGroup(groupKey, TOTAL_USER, doc.section);
    const osh = doc.categories.includes('BHP');

    totalGroup.suggestions += 1;
  ...
  function handleObservation(doc)
  {
    ...
    getGroup(groupKey, TOTAL_USER, doc.section).observations += 1;
  ...
  function handleMinutesForSafetyCard(doc)
  {
    ...
    getGroup(groupKey, TOTAL_USER, doc.section).minutes += 1;
  ...
  function handleAudit(doc)
  {
    ...
    getGroup(groupKey, TOTAL_USER, doc.section).audits += 1;
  ...
  function handleTalk(doc)
  {
    ...
    getGroup(groupKey, TOTAL_USER, doc.section).talks += 1;
