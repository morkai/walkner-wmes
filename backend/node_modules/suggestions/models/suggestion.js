...
exports.setUp = (app, mongoose) =>
{
  ...
  schema.methods.createObservers = function()
  {
    ...
    if (this.superior && !observers[this.superior.id])
    {
      observers[this.superior.id] = {
        user: this.superior,
        role: 'superior',
        lastSeenAt: null,
        notify: true,
  ...
  schema.methods.updateObservers = function(changedPropertyList, changes, newSubscribers)
  {
    ...
    // Superior
    if (this.superior && !newObserverMap[this.superior.id])
    {
      const observer = oldObserverMap[this.superior.id] || createObserver(this.superior, 'superior');
