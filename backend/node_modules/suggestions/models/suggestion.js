...
exports.setUp = (app, mongoose) =>
{
  ...
  suggestionSchema.index({finishedAt: -1});
  ...
  suggestionSchema.index({'suggestionOwners.id': 1});
  suggestionSchema.index({'kaizenOwners.id': 1});
  suggestionSchema.index({'confirmer.id': 1});
  suggestionSchema.index({'superior.id': 1});
  suggestionSchema.index({kom: 1});
  ...
  mongoose.model(exports.name, suggestionSchema);
};
