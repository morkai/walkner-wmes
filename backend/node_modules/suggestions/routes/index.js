...
module.exports = (app, module) =>
{
  ...
  express.get('/suggestions/:order/attachments/:attachment', canView, sendAttachmentRoute.bind(null, app, module));
  ...
  function prepareForAdd(req, res, next)
  {
    ...
    body.attachments = module.attachments.claimPendingUploads(body.attachments);
  ...
  {
    res.json(module.attachments.addPendingUploads(req.files));
  }
