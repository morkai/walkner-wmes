...
module.exports = (app, module, req, res, next) =>
{
  ...
  step(
    function findStep()
    {
      Suggestion.findById(req.params.id).exec(this.parallel());

      KaizenSection.findById(body._id).lean().exec(this.parallel());
    },
    function applyChangesStep(err, suggestion, kaizenSection)
    {
      if (err)
      {
      ...
      suggestion.coordSections.forEach(coordSection =>
      {
        ...
        {
          input.coordSections.push(coordSection);
