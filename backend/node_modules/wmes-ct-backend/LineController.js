...
module.exports = class LineController
{
  ...
  toggleLamps(done)
  {
    ...
    candidates.forEach(({rank, station}) =>
    {
      ...
      {
        if (station.lamp === 'off' || forceRequests)
        {
          toTurnOn.push(station);
        }
      }
      else if (station.lamp !== 'off' || forceRequests)
      {
    ...
    toTurnOff.forEach(station =>
    {
      ...
      lc.trace('Turning lamp off.', {station: station._id});
    ...
    toTurnOn.forEach(station =>
    {
      ...
      lc.trace('Turning lamp on.', {station: station._id, lamp: station.lamp});
