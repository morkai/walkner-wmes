...
module.exports = (app, subdivisionsModule, queryStream, emitter) =>
{
  const docs = [];
  let functionMap = {};
  let functionList = [];
  ...
  {
    doc.tasks.forEach(handleTask);

    if (Array.isArray(doc.fteDiv) && doc.fteDiv.length)
    {
      _.forEach(doc.fteDiv, (division) =>
      {
  ...
  function handleTask(task)
  {
    ...
    task.functions.forEach((taskFunction) => handleTaskFunction(taskFunctionMap, taskFunction));
  ...
  function handleTaskFunction(taskFunctionMap, taskFunction)
  {
    ...
    taskFunction.companies.forEach((taskCompany) =>
    {
      ...
      else
      {
        ...
        _.forEach(taskCompany.count, (taskDivision) =>
        {
