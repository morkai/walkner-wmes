...
module.exports = (app, module) =>
{
  ...
  function updateSupplyCount(updater, entry, data, done)
  {
    ...
    if (task.parent)
    {
      ...
      const prodTaskMaps = module.getCachedLeaderProdTaskMaps(data._id, entry);
  ...
  return {
    findOrCreate: findOrCreate.bind(null, app, module, FteLeaderEntry, 'LEADER'),
    updateCount: (socket, data, reply) =>
    {
      ...
      step(
        ...
        {
          module.getCachedEntry('leader', data._id, this.next());
        },
    ...
    updateComment: (socket, data, reply) =>
    {
      if (!_.isFunction(reply))
      {
        reply = () => {};
