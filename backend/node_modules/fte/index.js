...
exports.models = [
  require('./models/fteLeaderEntry'),
  require('./models/fteMasterEntry'),
  require('prodChangeRequests/models/prodChangeRequest')
];

exports.optionalModules = {
  'mongoose': require('./cache'),
  'mongoose user settings subdivisions settings express': require('./routes'),
  'mongoose user settings sio divisions subdivisions': require('./commands')
};
...
exports.start = function startFteModule(app, module)
{
  ...
  function changeShift()
  {
    ...
    module.info(`Shift changed.`, {shift: module.currentShift});
