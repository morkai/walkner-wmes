...
module.exports = (app, module) =>
{
  ...
  later.setInterval(() => runIfNotDuplicate(handleDailyReminder.bind(null, 0)), later.parse.cron('10 0 * * *'));
  later.setInterval(() => runIfNotDuplicate(handleWeeklyReminder.bind(null, 0)), later.parse.cron('20 0 * * 1'));
