  ...
  step(
    function()
    {
      ...
      ['oshDivision', 'oshWorkplace', 'oshDepartment'].forEach(orgUnitType =>
      {
        ...
        {
          userConditions[orgUnitType] = {$in: options[orgUnitType]};
        }
      });
    ...
    function(err, settings, users, employments)
    {
      if (err)
      {
      ...
      {
        observerMultiplier = employments.length;
      }
      ...
      users.forEach(user =>
      {
        ...
        {
          getOrgUnit(user.oshDepartment).observers += observerMultiplier;
        }
      });
