...
exports.report = (app, module, options, done) =>
{
  ...
  function finalizeGroup(group)
  {
    ...
    if (group.trc.target === -1)
    {
      group.trc.target = 0.35;
    }
    ...
    if (group.contact.target === -1)
    {
      group.contact.target = results.settings.obsCardsPerDepartment / 100;
    }
    ...
    {
      group.contact.itm = group.obs.cards / group.fte.itm * 100;
    }
    ...
    if (group.obs.plan === -1)
    {
      group.obs.plan = group.fte.itm * (results.settings.obsCardsPerDepartment / 100);
    }
