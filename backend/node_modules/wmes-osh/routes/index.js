...
const accidentsRoutes = require('./accidents');
...
const permalinkRoutes = require('./permalink');
...
module.exports = (app, module) =>
{
  ...
  accidentsRoutes(app, module);
  employmentsRoutes(app, module);
  targetsRoutes(app, module);
  brigadesRoutes(app, module);
  reportsRoutes(app, module);
  permalinkRoutes(app, module);
  rewardsRoutes(app, module);
  payoutsRoutes(app, module);
