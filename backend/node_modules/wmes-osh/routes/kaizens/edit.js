...
module.exports = async (app, module, req, res, next) =>
{
  ...
  try
  {
    ...
    if ((input.kind && input.kind !== kaizen.kind)
      || (input.department && input.department !== kaizen.department)
      || (input.location && input.location !== kaizen.location))
    {
      input.coordinators = await OshKaizen.resolveCoordinators(kaizen);
    }
