...
module.exports = async (app, module, req, res, next) =>
{
  ...
  try
  {
    const creator = !input.anonymous
      ? module.createUserInfo(req.session.user, req)
      : module.createUserInfo(module.config.anonymousUserInfo, {body: req.body});
    ...
    const [coordinators] = await Promise.all([
      OshNearMiss.resolveCoordinators(nearMiss, {exceptUsers: [nearMiss.creator]}),
