...
const transliterateFileName = require('wmes-osh/util/transliterateFileName');
...
module.exports = async (app, module, req, res, next) =>
{
  ...
  const releaseLock = await locks.createAsync(`${OshNearMiss.TOPIC_PREFIX}.${req.params.id}`);
