...
module.exports = (app, mongoose, modelName, schema) =>
{
  ...
  schema.statics.prepareCoordinatorsInput = async function(entry, input, props)
  {
    ...
    input.coordinators = await this.resolveCoordinators(coordinatorsInput);
  };

  schema.statics.resolveCoordinators = async function({kind, department, location})
  {
    const Entry = this;
