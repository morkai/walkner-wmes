...
exports.republishTopics = [
  ...
  'osh.actions.updated.*', 'osh.actions.seen.*',
  'osh.observations.added', 'osh.observations.edited', 'osh.observations.deleted',
  'osh.observations.updated.*', 'osh.observations.seen.*'
];
...
exports.start = (app, module) =>
{
  ...
  module.createUserInfo = (userData, addressData) =>
  {
    ...
    userInfo.workplace = userData.oshWorkplace || 0;
    userInfo.division = userData.oshDivision || 0;
