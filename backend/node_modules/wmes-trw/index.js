...
exports.recordTopics = {
  debug: [
    'trw.testers.added', 'trw.testers.edited',
    'trw.bases.added', 'trw.bases.edited',
    'trw.programs.added', 'trw.programs.edited'
  ],
  warning: ['trw.*.deleted']
};

exports.userPrivileges = ['TRW:VIEW', 'TRW:PROGRAM', 'TRW:MANAGE'];

exports.optionalModules = {
  'mongoose user updater express': require('wmes-trw/routes')
};
