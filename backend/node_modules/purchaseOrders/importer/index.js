...
exports.start = function startPurchaseOrdersImporterModule(app, module)
{
  ...
  function importFile(fileInfo)
  {
    ...
    module.info('Handling %d step for %s...', step, timeKey);
    ...
    if (stepsMap.steps < fileInfo.stepCount)
    {
      ...
      module.info('Delaying %s by %d ms (steps=%d)...', timeKey, delay, stepsMap.steps);
  ...
  function enqueueAndImport(timeKey, delayed)
  {
    ...
    if (delayed)
    {
      module.info('Queued %s (delayed)...', timeKey);
    }
    else
    {
      module.info('Queued %s...', timeKey);
    }
  ...
  function importNext()
  {
    ...
    {
      return module.info('Delayed %s: waiting for earlier data...', importQueue[0]);
    }
    ...
    importSteps(stepsMap, function(purchaseOrders)
    {
      ...
      module.info('Imported %s in %d ms!', timeKey, Date.now() - startTime);
