...
exports.setUp = (app, mongoose) =>
{
  ...
  const PAPERS = {
    'a4': {
      width: 210,
      height: 297,
      wkhtmltopdf: '-O Landscape -B 0 -L 0 -R 0 -T 0',
      qr: {
        zint: {
          scale: 3.5,
          vers: 5
    ...
    'vendor/48003321/A5': {
      width: 148,
      height: 210,
      wkhtmltopdf: '-O Portrait -B 0 -L 0 -R 0 -T 0',
      qr: {
        zint: {
          scale: 1,
          vers: 5
  ...
  mongoose.model(exports.name, purchaseOrderSchema);
};
