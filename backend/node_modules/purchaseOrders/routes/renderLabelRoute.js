...
module.exports = (app, module, req, res, next) =>
{
  ...
  step(
    ...
    function renderLabelPdfStep(err, print)
    {
      ...
      return request(reqOptions, this.next());
    },
    function(err, res, html)
    {
      ...
      html2pdf.generatePdf(html, this.pdfOptions, this.next());
    },
    function sendPdfStep(err, result)
    {
      if (err)
      {
        return next(err);
      ...
      res.sendFile(html2pdf.getPdfFilePath(result.hash));
    }
  );
};
