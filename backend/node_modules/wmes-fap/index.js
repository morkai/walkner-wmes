...
exports.republishTopics = [
  ...
  'fap.subCategories.added', 'fap.subCategories.edited', 'fap.subCategories.deleted'
];

exports.recordTopics = {
  debug: [
    'fap.categories.added', 'fap.categories.edited',
    'fap.subCategories.added', 'fap.subCategories.edited'
  ],
  warning: [
    'fap.entries.deleted',
    'fap.categories.deleted',
    'fap.subCategories.deleted'
  ]
};
