...
module.exports = (app, module) =>
{
  ...
  express.get('/fap/entries;export.:format?', canView, exportRoute.bind(null, app, module));
  ...
  express.get('/fap/entries', canView, prepareObserverFilter, express.crud.browseRoute.bind(null, app, FapEntry));
