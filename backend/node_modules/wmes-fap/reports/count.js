  ...
  step(
    ...
    function finalizeStep(err, categories)
    {
      ...
      while (groupKey <= maxGroupKey)
      {
        ...
        if (group)
        {
          group.duration = group.duration / (group.count || 1) / 3600000;
          group.analysisDuration = group.analysisDuration / (group.analysisCount || 1) / 3600000;
        }
      ...
      results.totals.duration = results.totals.duration / (results.totals.count || 1) / 3600000;
      results.totals.analysisDuration = results.totals.analysisDuration / (results.totals.analysisCount || 1) / 3600000;
