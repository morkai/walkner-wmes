...
module.exports = (app, module) =>
{
  ...
  function onEntryUpdated({_id, rid, change, notify})
  {
    ...
    if (notify && change.comment)
    {
      ...
      Object.keys(notify).forEach(userId =>
      {
        app.broker.publish(`fap.entries.notifications.${userId}`, {changed});
      });
    }
