  ...
  function edit(done)
  {
    step(
      ...
      function(err, entry)
      {
        ...
        const isProductionPlanner = user.isAllowedTo(sessionUser, [['FN:production-planner']]);
        ...
        if (canManage || isProcessEngineer || isQualityEngineer || isDesigner || isProductionPlanner)
        {
          props.push(
            'category',
            'subCategory'
