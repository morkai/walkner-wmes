...
module.exports = function(app, productionModule, prodLine, logEntry, done)
{
  ...
  step(
    ...
    function updateModelsStep(err, prodShiftOrder, prodDowntimes)
    {
      if (err)
      {
        productionModule.error(err, 'Failed to find order for edit.', {
      ...
      if (!prodShiftOrder)
      {
        productionModule.warn('Order not found for edit.', {
          prodShiftOrderId: logEntry.prodShiftOrder,
          prodLogEntryId: logEntry._id
        });
    ...
    function changeDowntimesStep(err)
    {
      if (err)
      {
        productionModule.error(err, 'Failed to save order after editing.', {
          prodShiftOrderId: logEntry.prodShiftOrder,
          prodLogEntryId: logEntry._id
        });
    ...
    function recalcOrderDurationsStep(err)
    {
      if (err)
      {
        productionModule.error(err, 'Failed to save downtimes after editing order.', {
          prodShiftOrderId: logEntry.prodShiftOrder,
          prodLogEntryId: logEntry._id
        });
