...
exports.optionalModules = {
  ...
  'subscriptions mailSender': require('./subscriptions')
};

exports.start = (app, module) =>
{
  module.FAP_PROPS = ['_id', 'rid', 'status', 'lines', 'orderNo', 'problem'];
