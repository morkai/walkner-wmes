...
exports.userPrivileges = ['OPERATOR:ACTIVATE', 'OPERATOR:ORDER_UNLOCK'];
...
exports.optionalModules = {
  ...
  'user settings fte orgUnits express': require('./routes'),
  'user settings fte orgUnits isa sio': require('./commands'),
