...
module.exports = function getPlanExecution(app, module, id, done)
{
  ...
  step(
    ...
    function(err, planOrders, sapOrders)
    {
      ...
      sapOrders.forEach(sapOrder =>
      {
        ...
        this.lineOrdersMap[sapOrder.no].workerCount = this.workerCountMap[sapOrder.mrp][this.shiftNo - 1] || 0;
