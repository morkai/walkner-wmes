...
module.exports = (app, module, socket, req, reply) =>
{
  ...
  step(
    ...
    function fetchDataStep()
    {
      ...
      if (req.orderQueue)
      {
        module.getOrderQueue(req.prodShiftId, {prev: true}, this.parallel());
      }
      else
      {
        setImmediate(this.parallel(), null, null);
      ...
      whProblemOrders)
    {
      ...
      reply({
        ...
        execution: orderQueue.execution,
        componentLabels: componentLabels || undefined,
        whProblems: Array.from(new Set(whProblemOrders.map(o => o.order)))
      });
    }
  );
};
