    ...
    step(
      ...
      function()
      {
        ...
        if (added.length)
        {
          ...
          DrillingOrder.collection.insertMany(added, {ordered: false}, (err, res) =>
          {
            if (err && err.result)
            {
              res = err.result;
        ...
        if (removed.length)
        {
          DrillingOrder.collection.deleteMany({_id: {$in: removed}}, this.group());
        }

        changed.forEach(change =>
        {
          DrillingOrder.collection.updateOne({_id: change._id}, {$set: change}, this.group());
        });
      },
      function(err)
      {
