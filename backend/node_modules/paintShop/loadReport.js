...
exports.report = (app, module, options, done) =>
{
  ...
  function handleGrouped(item)
  {
    ...
    inc(groupCounter, item.d, item.r);
    inc(totalCounter, item.d, item.r);
  }
  ...
  function inc(group, d, r)
  {
    ...
    if (group.delayed && (duration > results.settings.delayedDuration || r))
    {
