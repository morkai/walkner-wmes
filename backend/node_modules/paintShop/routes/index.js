...
module.exports = (app, module) =>
{
  ...
  // Ignored components
  express.get(
    '/paintShop/ignoredComponents', canView, express.crud.browseRoute.bind(null, app, PaintShopIgnoredComponent)
  );
  express.post(
    '/paintShop/ignoredComponents', canManage, express.crud.addRoute.bind(null, app, PaintShopIgnoredComponent)
  );
  express.get(
    '/paintShop/ignoredComponents/:id', canView, express.crud.readRoute.bind(null, app, PaintShopIgnoredComponent)
  );
  express.put(
    '/paintShop/ignoredComponents/:id', canManage, express.crud.editRoute.bind(null, app, PaintShopIgnoredComponent)
  );
  express.delete(
    '/paintShop/ignoredComponents/:id', canManage, express.crud.deleteRoute.bind(null, app, PaintShopIgnoredComponent)
  );
  ...
  express.get(
    '/paintShop/load;export.:format?',
    canView,
    exportLoad.bind(null, app, module)
  );
  ...
  {
    PaintShopLoad.getStats(+req.query.cabin, (err, stats) =>
    {
      if (err)
      {
        return next(err);
  ...
  {
    const limit = Math.min(3440, Math.max(1, req.rql.limit || 100));
    const conditions = {};

    if (req.query.cabin > 0)
    {
      conditions['_id.c'] = +req.query.cabin;
    }
  ...
  function loadReportRoute(req, res, next)
  {
    ...
    const options = {
      ...
      cabin: query.cabin > 0 ? +query.cabin : 0
    };
