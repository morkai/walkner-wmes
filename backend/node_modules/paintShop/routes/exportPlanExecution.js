...
module.exports = (app, module, req, res, next) =>
{
  ...
  const options = {
    ...
    columns: {
      ...
      paintingDuration: 'decimal',
      leadingManHours: 'decimal',
      childManHours: 'decimal'
    },
    cursor: null,
    ...
    cursor.on('end', () =>
    {
      ...
      Object.keys(paintToOrders).forEach(paint =>
      {
        ...
        Object.keys(leadingOrders).forEach(leadingOrderNo =>
        {
          ...
          const childOrderNos = Object.keys(childOrders);
          let leadingManHours = 0;

          childOrderNos.forEach(childOrderNo =>
          {
            leadingManHours += childOrders[childOrderNo].childOrder.manHours;
          });
          ...
          childOrderNos.forEach(childOrderNo =>
          {
            ...
            emitter.emit('data', {
              ...
              paintingDuration: leadingOrder.finishedAt
                ? (leadingOrder.finishedAt - leadingOrder.startedAt) / 3600 / 1000
                : 0,
              leadingManHours,
              childManHours: childOrder.manHours
            });
          });
        });
      });
