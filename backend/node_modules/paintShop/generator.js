...
module.exports = (app, module) =>
{
  ...
  function generate(date)
  {
    ...
    step(
      ...
      function(err, psSettings, planSettings, orders, startTimes)
      {
        if (err)
        {
        ...
        // TODO remove after 2019-07-23
        if (moment.utc(date).diff(moment.utc('2019-07-23'), 'days') >= 0)
        {
          psSettings.workCenters = _.without(psSettings.workCenters, 'MILING');
          psSettings.drillingWorkCenters = [];
          psSettings.unpaintedMrps = [];
        }
