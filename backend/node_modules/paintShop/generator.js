...
module.exports = function(app, module)
{
  ...
  function generate(date)
  {
    ...
    module.info(`[generator] [${key}] Generating...`);
    ...
    step(
      ...
      function(err, childOrders, unplannedOrders, splitChildOrders)
      {
        ...
        const unpaintedMrps = this.settings.unpaintedMrps || [];

        childOrders = childOrders.filter(childOrder =>
        {
          if (!unpaintedMrps.includes(childOrder.mrp))
          {
            return true;
          }
        ...
        childOrders.forEach(childOrder =>
        {
          ...
          if (!paint)
          {
            if (!unpaintedMrps.includes(leadingOrder.mrp))
            {
              return;
            }
