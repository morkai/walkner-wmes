...
exports.DEFAULT_CONFIG = {
  ...
  ccFilterRe: /^T_LS41_([0-9]+)\.txt$/,
  toFilterRe: /^T_LT23_([0-9]+)\.txt$/,
  uploadUrl: 'http://127.0.0.1/warehouse;import'
};

exports.start = function startWarehouseExporterModule(app, module)
{
  var filePathCache = {};
  var exportQueue = [];
  ...
  function filterFile(fileInfo)
  {
    ...
    var matches = fileInfo.fileName.match(module.config.toFilterRe);

    if (matches === null)
    {
      matches = fileInfo.fileName.match(module.config.ccFilterRe);
