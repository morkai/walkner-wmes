...
db.workcenters.update({_id: toUpdate[0].newOrgUnits.workCenter}, {$set: {
  description: 'Montaż Micro Luma - LM-35'
}});

db.prodflows.update({_id: toUpdate[0].newOrgUnits.prodFlow}, {$set: {
  name: 'Montaż Micro Luma - LM-35'
}});

db.prodlines.update({_id: toUpdate[0].newOrgUnits.prodLine}, {$set: {
  "description": 'Montaż UniStreet/LumiStreet/TownGuide - Linia LM-35'
}});
